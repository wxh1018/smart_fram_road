<template>
  <div class="highwayStatistics-div">
        ...
        <el-row :gutter="12">
          <el-col :span="8">
            <el-card class="oneCard-title" shadow="always">
              ...
              <span class="two">1010</span>
            </el-card>
          </el-col>
          <el-col :span="8">
            <el-card class="oneCard-title" shadow="always">
              <span class="one">总投资（万元）</span>
              <span class="two">444847</span>
            </el-card>
          </el-col>
          <el-col :span="8">
            <el-card class="oneCard-title" shadow="always">
              <span class="one">总里程（公里）</span>
              <span class="two">2330</span>
            </el-card>
          </el-col>
        </el-row>
      </el-card>
      <!-- 项目类型 -->
      <el-row class="title">公路类型</el-row>
      <el-card class="card-div">
        <el-row :gutter="20">
          <el-col :span="12">
...
export default {
  ...
  methods: {
    getEcharts() {
      ...
      const OneData_color=["#2edfa3", "#bce672", "#ff4777"]
      const Oneoption = {
      ...
      const TwoData_one = [343, 371, 296];
      const TwoData_two = [1010, 1010, 1010];
      const TwoData_three = [1010, 1010, 1010];
      var twoColor = ["#2edfa3", "#bce672", "#ff4777"];
      const TwoOption = {
      ...
      const ThreeData_tow = [80, 33, 129, 9, 13, 7, 203, 227, 199, 110];
      const ThreeOption = {
        backgroundColor: "#031845",
        tooltip: {},
        grid: {
