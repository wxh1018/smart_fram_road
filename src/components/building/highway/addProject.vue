<template>
  <div class="addProjectDrawer">
    ...
    <el-row class="center">
      <div>
        <el-form :model="projectList" ref="projectListRef" label-width="100px">
          <!-- 项目基本信息 -->
          <el-card>
            <div slot="header">
              <span>基本信息</span>
...
export default {
  ...
  created() {
    this.AddStyle(
      "#app > section > section > section > main > div > div.el-card.is-always-shadow > div > div.el-drawer__wrapper > div > div > section > div > div.center.el-row > div > form > div > div.el-card__header{background-color:#e2e2e2;height: 30px;display: flex;align-items: center;font-size: 18px;color: #0095ff;font-weight: bold;}"
    );
    this.AddStyle(
      "#app > div > main > div.right > div.content > div > div.el-card.is-always-shadow > div > div.el-drawer__wrapper > div > div > section > div > div.center.el-row > div > form > div > div.el-card__body > div > div > div > input{height:38px}"
    );
    this.AddStyle(
