...
export default {
  ...
  methods: {
    ...
    addProject() {
      ...
      this.$router.push("/building/bridge/addProject");
    },
    //查询项目事件
    searchProject(row) {
      this.addProjectVisible = true;
      ...
      this.$router.push({
        path: "/building/bridge/searchProject"
      });
    },
    //修改项目事件
    editProject(row) {
      ...
      this.$router.push({ path: "/building/bridge/editProject" });
    },
    //删除项目事件
